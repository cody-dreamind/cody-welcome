...
Web není dekorace k vizitce. Je to pracovní nástroj, který má dělat jednu nebo několik jasných věcí: přivést kvalifikovanou poptávku, vysvětlit produkt, zkrátit obchodní cyklus, odbavit podporu, prodat digitální službu nebo vybudovat důvěru. Pokud si to neřekneš před designem, skončíš u krásné vitríny, která se tváří jako strategie. To je drahá tapeta, ne web.

Začni otázkou: „Jaké rozhodnutí má návštěvník po návštěvě webu udělat?“ Odpověď musí být konkrétní. Ne „zaujmout“. Spíš: objednat konzultaci, stáhnout checklist, pochopit rozdíl mezi balíčky, ověřit reference, otevřít dokumentaci nebo se vrátit přes RSS.

> Codyho komentář: Když web neumí říct, pro koho je a co má člověk udělat dál, není minimalistický. Je jen potichu zmatený.

## Jedna hlavní práce webu

Každý web má mít jednu hlavní práci. Může mít vedlejší funkce, ale hlavní práce rozhoduje o struktuře, textech i měření.

Příklady:

- Konzultační firma: získat kvalitní poptávku od firmy, která už chápe problém.
- SaaS aplikace: dostat správného uživatele k prvnímu vyzkoušení produktu.
- Lokální služba: vysvětlit důvěryhodnost, cenu a další krok bez telefonického ping-pongu.
- Technický produkt: ukázat dokumentaci, integrace a bezpečnostní odpovědi pro rozhodovatele.
- Osobní brand: budovat dlouhodobou důvěru přes obsah, přímé odkazy a RSS.

Dobrá pracovní věta vypadá takto:

```text
Web pomáhá [typ zákazníka] pochopit [konkrétní hodnotu] a udělat [měřitelný další krok].
```

Příklad:

```text
Web pomáhá majitelům menších B2B firem pochopit, jak jim AI automatizace ušetří rutinní práci, a objednat úvodní konzultaci bez nutnosti psát dlouhý e-mail.
```

Tahle věta je nudná jen na první pohled. Ve skutečnosti rozhoduje, co bude v navigaci, jaký bude hlavní nadpis, které reference ukázat a jaký formulář má smysl.

## Tři vrstvy strategie

Strategii webu si rozděl na tři vrstvy: obchodní cíl, uživatelský cíl a provozní pravidla. Když chybí jedna z nich, web začne časem dělat kompromisy, které bolí.

### 1. Obchodní cíl

Obchodní cíl říká, proč web existuje z pohledu firmy.

Dobré cíle:

- získat 10 kvalifikovaných poptávek měsíčně,
- snížit počet opakovaných dotazů na podporu,
- zvýšit počet dokončených registrací do trialu,
- vysvětlit novou službu tak, aby obchod nemusel začínat od nuly,
- přivést lidi k obsahu, který buduje důvěru dlouhodobě.

Slabé cíle:

- „mít modernější web“,
- „vypadat profesionálně“,
- „být víc jako konkurence“,
- „něco s AI“,
- „ať se to líbí vedení“.

Vzhled je důležitý, ale není to cíl. Je to způsob, jak cíli pomoct.

### 2. Uživatelský cíl

Uživatel nepřichází obdivovat informační architekturu. Přichází vyřešit vlastní problém.

Před psaním textů si napiš pět nejčastějších otázek návštěvníka:

- Je to pro mě?
- Rozumí tahle firma mému problému?
- Kolik to přibližně stojí nebo jak se cena tvoří?
- Co se stane po kliknutí na tlačítko?
- Můžu tomu věřit?

Každá důležitá stránka má na tyto otázky odpovídat rychle a lidsky. Pokud musí návštěvník luštit interní názvy služeb, ztrácíš ho. Interní jazyk patří do Slacku, ne do hero sekce.

### 3. Provozní pravidla

Provozní pravidla určují, co web nikdy neudělá jen kvůli krátkodobé metrice.

Privacy-first pravidla pro Dreamind styl:

- žádné reklamní pixely při prvním načtení stránky,
- žádné povinné newsletterové pop-upy přes celý obsah,
- žádné temné vzory v cookie liště,
- žádné formuláře sbírající údaje „pro jistotu“,
- žádné externí skripty bez jasného vlastníka a důvodu,
- dostupné přímé odkazy, RSS a čitelný kontakt.

Tohle není asketismus. Je to značka. Návštěvník má cítit, že web mu nechce ukrást pozornost ani data, ale pomoct mu rozhodnout se.

## Mapa stránek podle rozhodnutí

Stránky nenavrhuj podle oddělení firmy. Navrhuj je podle rozhodnutí, která lidé dělají.

Praktický model:

| Rozhodnutí návštěvníka | Stránka nebo blok | Co musí obsahovat |
| --- | --- | --- |
| „Je to pro mě?“ | Úvodní stránka | jasný segment, problém, výsledek |
| „Umíte můj typ problému?“ | Služby / řešení | konkrétní scénáře, ne obecné fráze |
| „Můžu vám věřit?“ | Reference / případové studie | výsledek, kontext, proces |
| „Jak to probíhá?“ | Proces spolupráce | kroky, očekávání, odpovědnosti |
| „Kolik to bude stát?“ | Ceník / balíčky | rozsah, orientační cena nebo způsob nacenění |
| „Co mám udělat teď?“ | Kontakt / demo | jednoduchý formulář, alternativa e-mailem |

Když stránka nepodporuje žádné rozhodnutí, zvaž ji smazat, sloučit nebo přepsat. Každá položka v menu je malá půjčka pozornosti. Úroky platí návštěvník.

## Texty: konkrétněji než konkurence

Marketingové texty často umírají na bezpečné fráze. „Individuální přístup“, „moderní řešení“, „komplexní služby“ a „partner pro váš růst“ nezní špatně, jen neříkají skoro nic.

Přepiš obecné věty na konkrétní:

| Slabé | Lepší |
| --- | --- |
| Pomáháme firmám s digitalizací. | Automatizujeme opakované administrativní kroky v menších B2B týmech. |
| Nabízíme moderní weby. | Stavíme rychlé weby s jasnou strukturou, měřením bez reklamních pixelů a editovatelným obsahem. |
| Máme individuální přístup. | Před návrhem sepíšeme obchodní cíl, klíčové publikum a měřitelné další kroky. |
| Zvyšte efektivitu. | Zkraťte ruční zpracování poptávek z hodin na minuty pomocí formulářů, automatizace a přehledného CRM toku. |

Dobré pravidlo: pokud stejnou větu může bez úprav použít autoservis, advokát i SaaS startup, je moc obecná.

## Privacy-first jako obchodní argument

Soukromí nemusí být jen patička s právním textem. Pro evropské firmy může být součástí důvěry: provoz v Evropě, menší počet třetích stran, srozumitelná analytika, žádné zbytečné sledování a férové formuláře.

Jak to komunikovat bez moralizování:

- „Měříme jen agregovanou návštěvnost a klíčové akce.“
- „Nepoužíváme reklamní pixely při načtení stránky.“
- „Data z formuláře používáme jen pro odpověď na poptávku.“
- „Obsah můžete sledovat přes RSS bez registrace.“
- „Preferujeme evropský hosting a služby s jasnou kontrolou dat.“
...
- [ ] Víme, kdo je primární návštěvník a kdo není?
- [ ] Má každá hlavní stránka jasné rozhodnutí, které podporuje?
- [ ] Umíme popsat nabídku bez interního žargonu?
- [ ] Je hlavní CTA konkrétní a férové?
- [ ] Má návštěvník alternativu k formuláři, například e-mail nebo přímý kontakt?
- [ ] Víme, které metriky opravdu potřebujeme měřit?
- [ ] Máme seznam externích skriptů a důvod jejich použití?
- [ ] Umíme vysvětlit privacy-first přístup jedním odstavcem?
- [ ] Je možné web používat bez nátlaku, pop-upů a zbytečného sledování?

## Mini šablona strategického zadání

Použij před redesignem, novou landing page nebo spuštěním SaaS webu.

```text
Hlavní práce webu:
Primární publikum:
Koho web záměrně neřeší:
Nejdůležitější rozhodnutí návštěvníka:
Hlavní CTA:
Vedlejší CTA:
Tři nejčastější otázky návštěvníka:
Tři důkazy důvěry:
Metriky úspěchu:
Metriky, které záměrně nesbíráme:
Externí služby a důvod použití:
Privacy-first slib v jedné větě:
```

Strategie webu nemusí být padesátistránkový dokument. Stačí jedna dobrá stránka, která udrží tým při zemi. Když se pak někdo zeptá „neměli bychom tam dát ještě animovaný chatbot, popup a pět social tlačítek?“, máš podle čeho odpovědět: pomáhá to hlavní práci webu, nebo jen přidává hluk?
