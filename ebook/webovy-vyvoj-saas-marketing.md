...
## Příloha AI: Cookie consent bez manipulace a marketingového cirkusu

Cookie lišta není dekorace, ani právní amulet, který po vložení na web magicky odpustí všechny trackery. Je to rozhraní pro rozhodnutí člověka. Pokud je rozhraní navržené tak, aby uživatele dotlačilo k „souhlasím“, nejde o UX vítězství. Je to jen temný vzor v kravatě.

Privacy-first přístup začíná opačně: nejdřív se ptejte, jestli souhlas vůbec potřebujete. Pokud web funguje bez marketingových cookies, bez cross-site profilování a s agregovanou analytikou bez identifikátorů, možná nepotřebujete velký banner. Potřebujete stručnou informaci v patičce nebo privacy stránce, jasný inventář technických cookies a pravidelnou kontrolu, že se do webu nevloudil nový skript jako šváb do kuchyně.

*Codyho komentář:* Nejlepší cookie lišta je často ta, kterou nemusíte mít. Ne proto, že jste právně kouzlili, ale proto, že jste produkt navrhli tak, aby nesbíral zbytečnosti.

### AI.1 Rozdělte cookies podle skutečného účelu

Nezačínejte textem banneru. Začněte inventářem. Vytvořte tabulku všech cookies, localStorage položek, sessionStorage položek, pixelů, SDK a embedů. U každé položky napište, kdo ji nastavuje, kdy vzniká, co obsahuje, jak dlouho žije a k čemu slouží.

Praktické rozdělení:

| Kategorie | Příklad | Souhlas | Privacy-first doporučení |
|---|---|---:|---|
| Nezbytné | session, CSRF token, košík, jazyk | obvykle ne | držet krátce, popsat v privacy stránce |
| Preference | uložené nastavení tématu nebo jazyka | záleží na kontextu | ukládat lokálně, bez sdílení třetím stranám |
| Analytické | měření návštěvnosti a událostí | často ano, pokud identifikuje nebo profiluje | preferovat agregaci, EU provoz, bez cross-site ID |
| Marketingové | reklamní pixely, remarketing | ano | u privacy-first webu spíš nepoužívat |
| Externí obsah | video embed, mapa, chat widget | často ano nebo alespoň aktivní volba | použít klikací náhled a načíst až po akci |

Důležité: nerozhodujte podle názvu nástroje. Rozhodujte podle reálného datového toku. „Analytika“ může být šetrná metrika návštěvnosti, ale také identifikační aparát pro reklamní ekosystém. Stejná nálepka, úplně jiná zvířata.

### AI.2 Výchozí stav: nic volitelného se nespouští

Pokud používáte volitelné cookies nebo trackery, nesmí se načíst před souhlasem. To znamená prakticky:

- marketingové pixely nejsou v HTML natvrdo,
- tag manager se nespouští jako zadní vrátka pro všechno,
- embed třetí strany se nenačte před kliknutím nebo souhlasem,
- analytické eventy čekají na odpovídající volbu,
- odmítnutí se uloží stejně spolehlivě jako souhlas,
- změna volby je dostupná i později.

Technický test je jednoduchý: otevřete web v anonymním okně, nic neodsouhlaste a v devtools zkontrolujte cookies, localStorage, síťové požadavky a externí domény. Pokud vidíte marketingové endpointy před volbou, banner je jen divadlo. A špatné divadlo, protože divák ani netleská.

### AI.3 Banner pište jako rozhodnutí, ne jako past

Dobrá cookie lišta má být krátká, konkrétní a symetrická. Uživatel má vidět, co je nezbytné, co je volitelné a jaké má možnosti. Tlačítko pro odmítnutí nesmí být schované ve druhé vrstvě, napsané šedou na šedé nebo pod názvem „spravovat komfort“. Ano, kreativita copywriterů je mocná, ale tady ji držme na vodítku.

Dobrá první vrstva:

```text
Používáme nezbytné cookies pro fungování webu. Volitelné analytické cookies nám pomáhají zlepšovat obsah bez reklamního profilování. Můžete je přijmout, odmítnout nebo nastavit podrobně.

[Odmítnout volitelné] [Nastavit] [Přijmout volitelné]
```

Špatná první vrstva:

```text
Vážíme si vašeho soukromí. Pro nejlepší zážitek používáme naše důvěryhodné partnery. Pokračováním souhlasíte.

[Souhlasím]
```

První varianta dává volbu. Druhá varianta dává mlhu. Mlha je skvělá na hororu, ne na právním základu zpracování.

### AI.4 Nastavení musí být srozumitelné i po měsíci

Uživatel musí mít možnost volbu změnit. Ne jen v okamžiku první návštěvy, kdy se snaží dostat k obsahu a banner mu stojí v cestě jako turniket ve veřejné knihovně.

Doporučený provozní vzor:

- Do patičky přidejte odkaz „Nastavení soukromí“.
- V nastavení ukažte kategorie a konkrétní příklady služeb.
- U každé kategorie vysvětlete účel lidským jazykem.
- Uložte čas, verzi textu a vybranou volbu.
- Při zásadní změně účelu nebo dodavatele požádejte o novou volbu.
- Neobnovujte banner každých pár dní jen proto, že chcete „ještě jednu šanci“.

Pro interní provoz si ukládejte i verzi consent textu. Když později měníte analytiku, přidáváte embed nebo vyhazujete dodavatele, víte, k čemu uživatel původně dal souhlas. Bez verzování je z consentu historická hádanka.

### AI.5 Cookie lišta není náhrada za dobrou architekturu

Malý evropský SaaS má několik možností, jak se vyhnout zbytečnému consent chaosu:

- měřit agregovaně a bez reklamního profilování,
- hostovat fonty lokálně,
- nepoužívat social share skripty,
- video a mapy načítat až po kliknutí,
- používat RSS a přímé odkazy místo vložených widgetů,
- nedávat tag manager každému marketérovi jako univerzální šroubovák,
- pravidelně kontrolovat produkční HTML a síťové požadavky.

Tag manager není zlo sám o sobě. Problém je, že často umožní obejít normální review proces. Privacy-first tým by měl mít pravidlo: každý nový tag je změna datového toku, ne jen „marketing si něco přidal“. Tím pádem má vlastníka, účel, region, retenční pravidlo a test před nasazením.

### AI.6 Release checklist pro nový skript nebo cookie

Před nasazením nového měření, embedů nebo marketingového nástroje projděte tento checklist:

- [ ] Víme, jaké cookies, localStorage položky nebo identifikátory nástroj nastavuje.
- [ ] Víme, jaké osobní údaje nebo online identifikátory odcházejí mimo náš web.
- [ ] Známe zemi provozu a případné předání mimo EHP.
- [ ] Nástroj se nespustí před odpovídající volbou uživatele.
- [ ] Odmítnutí je stejně jednoduché jako přijetí.
- [ ] Změna volby je dostupná z patičky nebo privacy stránky.
- [ ] Text banneru odpovídá skutečnému technickému chování.
- [ ] Privacy policy a cookie inventář jsou aktualizované.
- [ ] QA test ověřil stav před souhlasem, po odmítnutí a po přijetí.
- [ ] Máme plán odstranění nástroje, pokud přestane být potřebný.

### Mini cvičení: cookie consent audit za 50 minut

1. Otevřete produkční web v anonymním okně.
2. Před kliknutím na banner zapište všechny cookies, localStorage položky a externí požadavky.
3. Klikněte na odmítnutí a zapište rozdíl.
4. Klikněte na přijetí a zapište rozdíl.
5. Porovnejte výsledek s textem banneru a privacy stránky.
6. Najděte jednu položku, která je zbytečná, nejasná nebo načtená příliš brzy.
7. Udělejte jednu opravu: odstranit skript, odložit embed, přepsat text, přidat odkaz na nastavení nebo upravit release checklist.

Výstupem má být krátká tabulka a jeden pull request. Ne tříhodinová debata, jestli je tlačítko „Přijmout“ emocionálně teplejší v modré nebo zelené. Spoiler: není.

### Zdroje k příloze AI

- ÚOOÚ v otázkách a odpovědích ke cookies uvádí, že u cookie lišty má být možné souhlas stejně jednoduše neudělit jako udělit a že je třeba informovat mimo jiné o době uložení, právech, odvolání souhlasu a možnosti podat stížnost: https://uoou.gov.cz/verejnost/qa-otazky-a-odpovedi/cookies
- ÚOOÚ k českému režimu od roku 2022 popisuje opt-in princip pro cookies, které nejsou nezbytné pro provoz služby: https://uoou.gov.cz/novinky/vse/cookies-od-zacatku-roku-2022-pouze-se-souhlasem
- Směrnice ePrivacy v čl. 5 odst. 3 řeší ukládání informací nebo přístup k informacím v koncovém zařízení uživatele a výjimku pro technicky nezbytné ukládání: https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A02002L0058-20091219
- GDPR čl. 4 a 7 definují souhlas a podmínky jeho prokazatelnosti, odvolatelnosti a srozumitelného oddělení od jiných sdělení: https://eur-lex.europa.eu/legal-content/CS/TXT/?uri=CELEX%3A32016R0679
- EDPB Guidelines 05/2020 on consent vysvětlují požadavky na svobodný, konkrétní, informovaný a jednoznačný souhlas a řeší i cookie walls a granularitu volby: https://www.edpb.europa.eu/our-work-tools/our-documents/guidelines/guidelines-052020-consent-under-regulation-2016679_en
...
Záloha není soubor někde v cloudu. Záloha je schopnost vrátit službu, data a důvěru do použitelného stavu v čase, který firma přežije. To je nepříjemně praktická definice, protože odhalí rozdíl mezi „něco se nám někam kopíruje“ a „umíme obnovit projekt, fakturaci, auditní logy a zákaznické přílohy bez paniky“.

Malý SaaS často řeší zálohy pozdě. Dokud je produkt mladý, vypadá to jako technická hygiena, která počká. Jenže data jsou postupně produktová paměť: účty, projekty, platby, komentáře, nastavení, dokumenty, support historie, auditní stopa. Když se ztratí, neobnovujete jen databázi. Obnovujete zákaznickou důvěru. A ta nemá tlačítko `restore`.

*Codyho komentář: nejnebezpečnější věta v provozu je „to se určitě zálohuje“. Druhá nejnebezpečnější je „to zjistíme, až bude potřeba“. Gratuluju, právě jste vynalezli chaos s latencí.*

### Co má být chráněné

Začněte inventářem obnovy, ne výběrem backup nástroje. Cílem není zazálohovat všechno stejně. Cílem je vědět, co musíte obnovit jako první, co může počkat a co se naopak do záloh nemá dostat vůbec.

Typické vrstvy:

- **Primární databáze:** účty, projekty, objednávky, nastavení, role, auditní události.
- **Objektové úložiště:** nahrané soubory, exporty, přílohy, faktury, obrázky, dokumenty.
- **Konfigurace:** proměnné prostředí, DNS, e-mailové domény, webhooky, feature flags, role v administraci.
- **Zdrojový kód a infrastruktura:** Git repozitář, infrastructure-as-code, migrační skripty, release tagy.
- **Provozní znalost:** runbooky, incident postupy, kontakty, přístupy k poskytovatelům.
- **Marketingová a obchodní data:** formuláře, consent záznamy, CRM exporty, šablony kampaní.

Privacy-first pointa: záloha není výmluva pro nekonečnou retenci. Pokud zákaznická data mažeme z produkce kvůli ukončení účtu nebo retenci, musíme mít rozumný plán, jak se mazání promítne i do záloh. Nemusí to znamenat okamžité fyzické vyříznutí ze všech archivů. Musí to ale znamenat jasnou retenci, omezený přístup a pravidlo, že obnovou staré zálohy omylem neoživíme data, která už měla být pryč.

### RPO a RTO lidsky

Dvě zkratky, které stojí za to znát:

- **RPO — Recovery Point Objective:** kolik dat si můžete dovolit ztratit. Například „maximálně 15 minut objednávek“ nebo „maximálně 24 hodin analytických agregátů“.
- **RTO — Recovery Time Objective:** jak rychle má být služba nebo proces zpět. Například „login do 2 hodin“, „export dat do 1 pracovního dne“.

Neopisujte hodnoty z enterprise prezentací. Malý SaaS má být realistický. Pokud nemáte nonstop tým, neslibujte obnovu do 15 minut. Pokud nemáte ověřený restore test, neslibujte nic s přesností na minuty. Interně si ale hodnoty napište, protože bez nich nevíte, jak často zálohovat, co automatizovat a co musí mít ruční postup.

Příklad:

| Oblast | RPO | RTO | Poznámka |
| --- | ---: | ---: | --- |
| Primární databáze | 15 minut | 4 hodiny | PITR nebo časté snapshoty, pravidelný restore test |
| Objektové úložiště | 1 hodina | 8 hodin | verze souborů, ochrana proti hromadnému smazání |
| Faktury a billing exporty | 24 hodin | 1 pracovní den | oddělený export, šifrované uložení |
| Marketingové agregáty | 24 hodin | 2 pracovní dny | není kritická cesta produktu |
| Dokumentace a runbooky | 24 hodin | 4 hodiny | Git nebo export mimo primární nástroj |

Tohle není právní kouzlo. Je to provozní dohoda. Když spadne služba, tým nemá debatovat, jestli je důležitější obnovit blog, faktury nebo zákaznické projekty. Má to vědět dopředu.

### Pravidlo 3-2-1 s evropskou hlavou

Klasické pravidlo 3-2-1 říká: mějte alespoň tři kopie dat, na dvou různých typech úložiště, z toho jednu mimo hlavní prostředí. Pro malý evropský SaaS bych ho přepsal praktičtěji:

1. **Produkční data:** běžná databáze a soubory.
2. **Rychlá obnova:** snapshoty nebo point-in-time recovery ve stejném regionu či poskytovateli.
3. **Oddělená kopie:** šifrovaná kopie mimo primární účet, ideálně v evropském regionu a s jinými přístupy.
4. **Ochrana proti kompromitaci:** immutable, offline nebo jinak oddělená záloha, kterou útočník s běžným admin účtem nesmaže.
5. **Test obnovy:** důkaz, že data nejdou jen uložit, ale i vrátit.

Ano, to je spíš 3-2-1-plus než čisté 3-2-1. Důvod je jednoduchý: ransomware a kompromitované účty nemají úctu k historickým pravidlům. Pokud backup účet používá stejné přihlášení jako produkce, útočník nemá problém se zálohami. Má bonusovou úroveň.

Privacy-first doporučení:

- držte zálohy v EU nebo u poskytovatele, kde umíte smluvně i technicky obhájit přenosy,
- šifrujte zálohy při přenosu i v klidu,
- oddělte přístupy k produkci a zálohám,
- logujte přístup k zálohám,
- pravidelně mažte staré zálohy podle retenčního kalendáře,
- neukládejte do záloh tajemství, která tam nemusí být, například staré exporty s API klíči.

### Restore test je produktová funkce

Největší chyba není chybějící záloha. Největší chyba je netestovaná záloha, která se tváří jako řešení. Restore test má být pravidelný, krátký a zdokumentovaný. Nemusí pokaždé obnovovat celou firmu. Musí ale ověřit nejdůležitější cesty.

Minimální měsíční test:

1. Vyberte jednu databázovou zálohu z posledních 7 dní.
2. Obnovte ji do izolovaného prostředí, ne do produkce.
3. Ověřte, že aplikace naběhne proti obnovené databázi.
4. Zkontrolujte reprezentativní záznamy: uživatel, projekt, role, auditní log, faktura nebo export.
5. Ověřte, že citlivá data nejsou viditelná lidem mimo nutný testovací tým.
6. Zapište čas obnovy, chyby, ruční kroky a rozdíl proti RTO.
7. Testovací prostředí bezpečně smažte.

Kvartální test by měl jít dál: simulujte ztrátu primární databáze, hromadné smazání souborů nebo kompromitaci admin účtu. Ne proto, abyste hráli kybernetické divadlo s dramatickou hudbou. Protože většina slabin se neukáže v dokumentaci, ale v ručním kroku, který umí jen jeden člověk na dovolené.

### Co nezálohovat slepě

Zálohovat všechno navždy zní bezpečně, ale privacy-first provoz říká: opatrně. Některá data do dlouhých záloh nepatří, nebo mají mít kratší retenci než jádro produktu.

Zvlášť kontrolujte:

- dočasné exporty zákaznických dat,
- ladicí dumpy databází,
- logy s osobními údaji,
- support přílohy,
- nahrávky hovorů a obrazovek,
- staré marketingové CSV importy,
- soubory s tokeny, hesly nebo privátními klíči.

Praktické pravidlo: pokud by bylo nepříjemné vysvětlovat zákazníkovi, proč je daný soubor ještě po roce v backup archivu, pravděpodobně potřebuje kratší retenci nebo lepší proces mazání.

### Backup karta systému

Použijte tuhle kartu pro databázi, objektové úložiště, CRM, fakturaci i dokumentaci. Jeden systém, jedna karta.
...
## Data
- Jaké typy dat obsahuje:
- Obsahuje osobní data? ano/ne
- Obsahuje citlivá nebo smluvní data? ano/ne

## Obnova
- RPO:
- RTO:
- Priorita obnovy: P1/P2/P3
- Závislosti pro obnovu:

## Zálohování
- Frekvence:
- Umístění primární zálohy:
- Oddělená/offline/immutable kopie:
- Šifrování:
- Retence:
...
- Kde se loguje přístup:
- Jak se odebírá přístup při offboardingu:
...
### Incident: záloha existuje, ale obnova selže

Tohle je scénář, který bolí, protože tým nejdřív zažije úlevu a pak pád do sklepa. Záloha je poškozená, chybí klíč, migrační skript nejde pustit, objektové soubory nejsou ve stejném stavu jako databáze nebo dokumentace obnovy odkazuje na člověka, který už ve firmě není.

První postup:

1. Zastavte další automatické mazání nebo přepis záloh.
2. Izolujte poslední známé dobré kopie.
3. Zapište časovou osu pokusů o obnovu.
4. Oddělte technickou obnovu od zákaznické komunikace.
5. Ověřte, jestli jde obnovit částečná funkčnost.
6. Zkontrolujte, zda incident zahrnuje osobní data a spouští povinnost posouzení nebo oznámení.
7. Po obnově udělejte postmortem zaměřený na proces, ne na hledání obětního admina.

Pokud incident zahrnuje osobní data, nespoléhejte na pocit. GDPR pracuje s rizikem pro práva a svobody lidí a v některých případech vyžaduje oznámení dozorovému úřadu bez zbytečného odkladu, nejpozději do 72 hodin od zjištění. To neznamená panikařit. Znamená to mít v incident playbooku jasnou větev pro posouzení dopadu na osobní data.

### Checklist: zálohy, kterým se dá věřit

- [ ] Máme seznam systémů, které musíme umět obnovit.
- [ ] Každý kritický systém má RPO, RTO a vlastníka.
- [ ] Zálohy databáze, souborů, konfigurace a dokumentace řešíme odděleně.
- [ ] Existuje kopie mimo primární účet nebo prostředí.
- [ ] Kritické zálohy jsou šifrované a přístup k nim je oddělený od produkce.
- [ ] Máme ochranu proti hromadnému smazání nebo kompromitaci admin účtu.
- [ ] Restore test běží pravidelně a má zápis.
- [ ] Víme, které typy dat do dlouhých záloh nepatří.
- [ ] Retence záloh odpovídá retenčnímu kalendáři a zákaznickým slibům.
- [ ] Obnova staré zálohy má krok pro opětovné promítnutí mazání a změn oprávnění.
- [ ] Backup dokumentace je dostupná i při výpadku hlavního nástroje.
- [ ] Po každém restore testu vznikne konkrétní oprava nebo potvrzení, že postup funguje.

### Mini cvičení: první restore test za 90 minut

1. Vyberte jeden kritický systém, ideálně primární databázi nebo objektové úložiště.
2. Vyplňte backup kartu jen pro tento systém.
3. Najděte poslední zálohu a ověřte, kdo k ní má přístup.
4. Obnovte ji do izolovaného prostředí.
5. Spusťte minimální aplikační kontrolu nebo ruční kontrolu dat.
6. Změřte čas od začátku obnovy po použitelný výsledek.
7. Zapište, co chybělo: klíče, dokumentace, oprávnění, skript, člověk, rozhodnutí.
8. Naplánujte jednu opravu do 14 dní.

Hotovo není ve chvíli, kdy backup job svítí zeleně. Hotovo je ve chvíli, kdy někdo jiný než původní autor umí podle dokumentace obnovit důležitou část systému. Zelená fajfka je hezká. Obnovená služba je lepší.

### Zdroje k příloze AO

- UK National Cyber Security Centre v části Data security doporučuje více záloh na různých místech, 3-2-1 pravidlo, oddělené offline zálohy a pravidelné testování obnovy: https://www.ncsc.gov.uk/collection/10-steps/data-security
- NIST SP 800-34 Rev. 1 popisuje contingency planning pro informační systémy včetně vazby na zálohy, obnovu a testování plánů: https://csrc.nist.gov/pubs/sp/800/34/r1/upd1/final
- ENISA Technical Implementation Guidance k řízení kybernetických rizik zmiňuje pravidlo 3-2-1, šifrování záloh a propojení disaster recovery s incident response: https://www.enisa.europa.eu/sites/default/files/2025-06/ENISA_Technical_implementation_guidance_on_cybersecurity_risk_management_measures_version_1.0.pdf
...
AI asistent v produktu může být výborný sluha: shrne dlouhé ticketové vlákno, navrhne odpověď zákazníkovi, pomůže uživateli najít funkci nebo přepíše interní poznámku do lidské češtiny. Může být ale taky luxusní potrubí, kterým omylem posíláte zákaznická data do nástroje, jehož nastavení nikdo nečetl, smlouvu nikdo nekontroloval a logy nikdo neumí najít. To už není inovace. To je jen dražší verze tlačítka „odeslat problém někam do mlhy“.

Praktický cíl této přílohy: navrhnout AI asistenta tak, aby pomáhal práci, ale nerozbil důvěru, GDPR logiku, bezpečnostní model ani evropský privacy-first provoz. Nejde o odmítání AI. Jde o to, aby AI funkce měla stejnou disciplínu jako platební brána, export dat nebo admin oprávnění.

### BA.1 Začněte rozhodnutím, ne promptem

Nejhorší zadání zní: „Přidejme AI asistenta.“ To není zadání. To je konfeta vystřelená do backlogu. Začněte rozhodnutím, které má AI zlepšit.

Dobrá zadání:

- support chce zkrátit první návrh odpovědi u opakovaných dotazů,
- obchod chce vytvořit shrnutí CRM poznámek před follow-upem,
- uživatel chce najít správnou akci v komplikovaném nastavení,
- produktový tým chce seskupit anonymizovanou zpětnou vazbu podle témat,
- administrátor chce rychleji pochopit, proč import selhal.

Špatná zadání:

- „budeme mít chatbota, protože ho má konkurence“,
- „napojíme model na všechna data a uvidíme“,
- „AI bude odpovídat zákazníkům sama, člověk to občas zkontroluje“,
- „pošleme tam celé databázové řádky, ať má kontext“.

AI funkce má mít vlastní kartu: účel, uživatel, vstupní data, výstup, hranice použití, riziko chyby, schvalování a plán vypnutí. Pokud kartu neumíte vyplnit, AI ještě nemáte připravenou. Máte jen demo. Demo je fajn na konferenci. Méně fajn ve fakturačním systému.

### BA.2 Rozdělte AI podle rizika

Ne každá AI funkce má stejné riziko. Překlad interního textu je něco jiného než automatické doporučení, komu schválit úvěr, koho vyřadit z náboru nebo komu omezit účet. EU AI Act pracuje s rizikovým přístupem a od 2. srpna 2026 začaly platit a vymáhat se mimo jiné nové transparentní povinnosti pro vybrané AI systémy; u systémů s vyšším rizikem se termíny a povinnosti liší podle kategorie a konkrétního použití. Proto nestačí říct „používáme AI“. Musíte říct kde, k čemu a s jakým dopadem.

Pro malý SaaS používejte čtyři pracovní třídy:

1. **Pomocník pro text:** návrh odpovědi, shrnutí, přepis, překlad. Nízké až střední riziko podle dat.
2. **Vyhledávání a doporučení:** nápověda v produktu, návrh další akce, třídění ticketů. Střední riziko, protože může měnit chování uživatele nebo týmu.
3. **Automatizace interního workflow:** návrh priority, kategorizace incidentů, kontrola fakturačních anomálií. Střední až vyšší riziko podle dopadu.
4. **Rozhodování o lidech nebo právech:** nábor, kredit, pojištění, vzdělávání, zaměstnanci, přístup ke službě. Vysoké riziko nebo právně citlivá oblast; bez právní a bezpečnostní kontroly sem nechoďte.

Codyho komentář: jestli vám někdo tvrdí, že „je to jen doporučení algoritmu“, zeptejte se, kdo nese následky, když se tím doporučením tým začne řídit automaticky. Ticho po otázce bývá nejlepší metrika rizika.

### BA.3 Minimalizujte kontext dřív, než minimalizujete náklady

U AI se často optimalizují tokeny kvůli ceně. To je užitečné, ale privacy-first pořadí je jiné: nejdřív minimalizujte data kvůli riziku, potom kvůli nákladům.

Před odesláním promptu si položte pět otázek:

- Potřebuje model celé jméno zákazníka, nebo stačí role?
- Potřebuje e-mail, telefon, IP adresu, interní ID nebo fakturační údaje?
- Potřebuje celé vlákno, nebo jen poslední zprávu a bezpečně vybraný kontext?
- Potřebuje přílohy, nebo jen extrahovaný úryvek bez osobních údajů?
- Potřebuje data uložit u dodavatele, nebo stačí jednorázové zpracování bez trénování?

Praktický pattern pro support asistenta:

```markdown
Vstup do modelu:
- typ dotazu: fakturace / technický problém / onboarding
- anonymizované shrnutí problému
- relevantní článek dokumentace
- tón odpovědi
- omezení: nenavrhovat slevu, neslibovat termín, neposuzovat právní věci
...
- API klíče, tokeny, session ID
- kompletní historii účtu
```

Když AI potřebuje kontext, vytvořte kontextovou vrstvu. Ne „vezmi všechno z databáze“. Kontextová vrstva je úzké API, které vrací jen schválená pole a má logiku pro redakci citlivých údajů. Ano, je to práce navíc. Přesně proto je to bezpečnostní opatření, ne dekorace v architektuře.

### BA.4 Lidské schválení není formalita

U generativní AI je velké lákadlo pustit výstup rovnou ven. Nedělejte to u věcí, které mohou poškodit zákazníka, značku nebo bezpečnost. AI může navrhnout odpověď, ale člověk má zkontrolovat význam, tón, slib, přesnost a datovou bezpečnost.

Pravidla pro human-in-the-loop:

- návrh odpovědi zákazníkovi musí být před odesláním viditelně označený jako návrh,
- systém nesmí skrýt původní zdrojový kontext,
- člověk musí vidět, které části byly doplněné modelem,
- nebezpečné akce nesmí jít provést jen přes AI návrh,
- odmítnutí nebo úprava návrhu se má používat jako signál kvality, ne jako ostuda operátora.

Užitečný detail: logujte rozhodnutí, ne zbytečný obsah. Například „AI navrhla kategorii billing, člověk změnil na technical“ je užitečný provozní signál. Ukládat celý prompt se zákaznickými osobními daty navždy je datové syslení v laboratorním plášti.

### BA.5 Transparentnost napište lidsky

Pokud uživatel interaguje s AI systémem nebo dostává obsah vytvořený či výrazně upravený AI, řešte transparentnost včas. Evropská komise k AI Actu zdůrazňuje, že od 2. srpna 2026 začala vymáhat pravidla a nové transparentní požadavky, včetně situací, kdy mají uživatelé vědět, že komunikují s AI nebo že obsah byl AI vytvořen či upraven.

Dobrá transparentní věta v produktu:

> Tento návrh odpovědi vytvořil AI asistent z vybraného kontextu ticketu a dokumentace. Před odesláním ho kontroluje člověk.

Dobrá věta v nápovědě:

> AI vyhledávání může navrhnout relevantní postup, ale neprovádí akce za vás a nemá přístup k platebním údajům.

Špatná věta:

> V rámci zlepšování uživatelského zážitku můžeme využívat pokročilé technologie.

To není transparentnost. To je mlhový generátor. Uživatel má pochopit, co AI dělá, jaký má dopad a kde končí její pravomoc.

### BA.6 Vyberte dodavatele podle datového režimu

Při výběru AI dodavatele neřešte jen kvalitu modelu a cenu. Zeptejte se:

- kde se zpracování fyzicky a smluvně odehrává,
- jestli se vstupy nebo výstupy používají k trénování,
- jak dlouho dodavatel drží logy,
- kdo má k logům přístup,
- zda existuje DPA a seznam subprocesorů,
- jak funguje mazání a export,
- jestli lze nastavit region, retenci a vypnutí ukládání,
- jak dodavatel řeší incidenty a změny modelu.

Privacy-first default pro evropský SaaS: pokud můžete úlohu vyřešit menším modelem v evropském provozu, udělejte to. Nejlepší model na světě není automaticky nejlepší volba pro shrnutí tří odstavců interní poznámky. Občas nepotřebujete raketu. Potřebujete dobře označené koště.

### BA.7 Šablona: karta AI funkce

```markdown
# AI funkce: [název]

## Účel
- Jaké rozhodnutí nebo práci zlepšuje:
- Kdo ji používá:
- Co je výstup:
- Co výstup nesmí dělat:

## Riziková třída
- Pomocník pro text / doporučení / interní workflow / citlivé rozhodování:
- Dopad chyby:
- Potřebná kontrola člověkem:

## Data
- Vstupní data povolená:
- Vstupní data zakázaná:
- Redakce nebo anonymizace před odesláním:
- Retence promptů a výstupů:

## Dodavatel a provoz
- Model nebo služba:
- Region zpracování:
- Trénování na našich datech: ano/ne
- DPA a subprocesoři:
- Logy a incident kontakt:

## UX a transparentnost
- Jak uživatel pozná AI výstup:
- Kde je vysvětlení limitů:
- Jak lze výstup upravit, odmítnout nebo nahlásit:

## Měření
- Agregovaný signál hodnoty:
- Signál rizika:
- Review rytmus:
- Vlastník:
...
## Vypnutí
- Kdy funkci vypneme:
- Jaký je fallback proces:
- Jak smažeme nebo omezíme uložené výstupy:
```

### BA.8 Checklist: AI asistent bez úniku kontextu

- [ ] AI funkce řeší konkrétní rozhodnutí nebo práci, ne obecné „přidání AI“.
- [ ] Máme rizikovou třídu a víme, jaký dopad může mít chyba.
- [ ] Prompt dostává jen minimální schválený kontext.
- [ ] Citlivá pole jsou redigovaná před odesláním, ne až po něm.
- [ ] Uživatel nebo operátor vidí, že jde o AI návrh.
- [ ] Člověk schvaluje výstupy, které jdou zákazníkovi nebo mění jeho situaci.
- [ ] Dodavatel má ověřený datový režim, retenci, DPA a subprocesory.
- [ ] Logujeme provozní rozhodnutí, ne zbytečně kompletní osobní obsah.
- [ ] Máme fallback, vypínač a vlastníka review.
- [ ] Veřejné texty o AI odpovídají tomu, co systém opravdu dělá.

### Mini cvičení: AI funkce za 70 minut

1. Vyberte jednu AI funkci, která už existuje nebo je v backlogu.
2. Napište její účel jednou větou bez slova „AI“.
3. Zařaďte ji do rizikové třídy.
4. Vypište všechna vstupní data, která dnes nebo plánovaně dostává.
5. Škrtněte každé pole, které není nutné pro výsledek.
6. Napište transparentní větu pro uživatele nebo operátora.
7. Ověřte dodavatele: trénování, retence, region, DPA, subprocesoři.
8. Doplňte fallback: co tým udělá, když AI funkci vypnete.

Výstupem má být jedna karta AI funkce a tři konkrétní úpravy: jedno omezení dat, jedno UX vysvětlení a jedno provozní pravidlo. Jestli z toho vznikne desetistránkový AI manifest, vraťte se na začátek. Cílem je bezpečnější produkt, ne dokument, který bude číst jen compliance archeolog.

### Zdroje k příloze BA

- Evropská komise oznámila, že AI Act vstoupil v platnost 1. srpna 2024 a zavádí povinnosti podle rizikových kategorií AI systémů: https://commission.europa.eu/news-and-media/news/ai-act-enters-force-2024-08-01_en
- AI Act Service Desk Evropské komise uvádí implementační milníky včetně postupného náběhu povinností a plného rozjezdu hlavních aplikačních milníků do 2. srpna 2028: https://ai-act-service-desk.ec.europa.eu/en/ai-act/eu-ai-act-implementation-timeline
- Evropská komise informovala, že od 2. srpna 2026 začíná vymáhání pravidel AI Actu a nových transparentních požadavků pro vybrané AI systémy: https://digital-strategy.ec.europa.eu/en/news/commission-starts-enforcing-ai-act-rules-and-new-transparency-requirements-2-august
